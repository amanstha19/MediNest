...
const BookingSuccessScreen = () => {
  ...
  useEffect(() => {
    const fetchBookingDetails = async () => {
      try {
        // For now, we'll just show a success message since we don't have individual booking fetch
      ...
      {bookingDetails ? (
        <div style={{ width: '100%' }}>
          <div className="eh-center" style={{ marginBottom: 'var(--eh-spacing-2xl)' }}>
            ...
            <h1 style={{ fontSize: '2rem', color: 'var(--eh-success)', marginBottom: 'var(--eh-spacing-md)' }}>Booking Confirmed Successfully!</h1>
            <p style={{ color: 'var(--eh-text-muted)', fontSize: '1.1rem' }}>Thank you for your booking. Your appointment has been confirmed.</p>
          </div>
            ...
            <CardContent>
              <div style={{ display: 'grid', gap: 'var(--eh-spacing-lg)' }}>
                ...
                <div style={{ paddingBottom: 'var(--eh-spacing-lg)', borderBottom: '1px solid var(--eh-border)' }}>
                  ...
                  <span style={{ background: 'var(--eh-success)', color: 'white', padding: '6px 12px', borderRadius: 'var(--eh-radius-sm)', fontWeight: 600 }}>
                    Confirmed
                  </span>
                </div>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '1rem' }}>
                    ...
                    You can check your booking status using the "Check Status" tab on the booking page.
                  </p>
                </div>
              </div>

              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--eh-spacing-md)', marginTop: 'var(--eh-spacing-2xl)' }}>
                <Button variant="primary" onClick={() => navigate('/book-test/1')}>Book Another Test</Button>
